	...
	class Pion extends Piece{
		...
		function printImgPiece($x,$y){
			if ($this->campDeLaPiece == 1){
				echo "<img src='image/pion.png' class='reverse' id='$x,$y' draggable='true' ondragstart='onDragStart(event);' x='$x' y='$y' camp='1'></img>";
			}
			else {
				echo "<img src='image/pion.png' id='$x,$y' draggable='true' ondragstart='onDragStart(event);' x='$x' y='$y' camp='2'></img>";
			}
			//echo "<img src='image/pion.png' id='$x,$y' draggable='true'></img>";
		}
